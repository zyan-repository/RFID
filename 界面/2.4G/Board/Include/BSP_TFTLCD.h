#ifndef __BSP_TFTLCD_H
#define __BSP_TFTLCD_H
...
#define RGB(R,G,B)	(((B >> 3) << 11) | ((G >> 2) << 5) | (R >> 3))	/* 将8位R,G,B转化为 16位RGB565格式 */  //huo 20171206
#define RGB565_R(x)  ((x << 3) & 0xF8)
#define RGB565_G(x)  ((x >> 3) & 0xFC)
#define RGB565_B(x)  ((x >> 8) & 0xF8)
enum
{
