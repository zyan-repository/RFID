...
{
	RA8875_DrawRoundRect(_usX, _usY, _usHeight, _usWidth, _usArc, _usColor);
}
...
void LCD_FillRoundRect(uint16_t _usX, uint16_t _usY, uint16_t _usHeight, uint16_t _usWidth,
	uint16_t _usArc, uint16_t _usColor)
{
	RA8875_FillRoundRect(_usX, _usY, _usHeight, _usWidth, _usArc, _usColor);
}
...
{
	RA8875_FillCircle(_usX, _usY, _usRadius, _usColor);
}
